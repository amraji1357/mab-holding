export default function RayanZomorodPage() {
  return (
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 md:grid-cols-[0.7fr_1.3fr]">
          ...
          <div>
            ...
            <p className="mt-10 text-lg leading-9 text-black/55">
              شرکت رایان زمرد یکی از مجموعه‌های زیرمجموعه هلدینگ
              بی‌رامی است. اطلاعات کامل درباره فعالیت، خدمات،
              حوزه کاری و چشم‌انداز این شرکت در این بخش قرار خواهد گرفت.
            </p>
          </div>
        </div>
      </section>
